...
<h2 align="left">About me:<br>Passionate Frontend Developer crafting clean, responsive UIs with modern web technologies.<br>I love turning ideas into interactive, user-friendly web experiences.</h2>

###

<p align="left">📚 I'm currently learning: Advanced React patterns, TypeScript, and performance optimization for modern web apps.<br>🎯 Goals:<br>* Build accessible, high-performance <br>   web applications.<br>* Deepen my expertise in React, <br>   TypeScript, and Next.js.<br>* Contribute to open-source projects <br>   and collaborate with the dev <br>   community.<br>* Continuously improve UI/UX skills <br>   and stay updated with modern <br>    frontend trends.</p>
